...
class Parser:
    ...
    def set_arguments(self):
        ...
        self.parser.add_argument('--fedmethod', type=str, default='fedshare', help='method i.e. fedavg fedshare fedloss')

        self.parser.add_argument('--task', type=str, default='ls-biid-diri-c10-lab50-d1-share0.03-only-expert-balance',
                                 help='task i.e. '
                                      'ls-bimb-c10, '
                                      'ls-biid-diri-c10-d1.0, '
                                      'ls-biid-diri-c10-lab50-d1.0-share0.01-only-expert'
                                      'ls-biid-diri-c10-lab50-d1.0-share0.03-only-expert-balance'
                                      'ls-biid-diri-mnist-lab50-d1.0-share0.03-only-expert-balance'
                                      )
